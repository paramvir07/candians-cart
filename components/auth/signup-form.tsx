...
//   className?: string;
//   /** When true, skips the component's own mobile shell (image + card).
//    *  Use this when the parent (SignupClient) already provides the shell. */
//   bare?: boolean;
// };

// export function SignupForm({ userRole, stores, className, bare = false }: SignupFormProps) {
...
//   const formContent = (
//     <>
//       {/* Logo + heading — hidden when bare (parent shows logo) */}
//       {!bare && (
//         <div className="mb-7">
//           <div className="hidden md:flex h-12 items-center justify-left mb-6">
...
//       {/* Heading shown in bare mode (no logo, parent owns that) */}
//       {bare && (
//         <div className="mb-5">
...
//           required
//           className="h-11 rounded-xl border-border bg-background px-4 text-sm placeholder:text-muted-foreground focus-visible:ring-1 focus-visible:ring-primary"
//         />
...
//             required
//             className="h-11 rounded-xl border-border bg-background px-4 pr-11 text-sm placeholder:text-muted-foreground focus-visible:ring-1 focus-visible:ring-primary"
//           />
//           <Button
//             variant="ghost"
//             type="button"
...
//             type="text"
//             name="address"
//             placeholder={store ? "Full Store Address" : "Address (e.g. 308-123 Main St)"}
...
//               required
//               defaultValue=""
//               className="flex-1 h-11 rounded-xl border border-border bg-background px-4 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
//             >
...
//               required
//               defaultValue="BC"
//               className="w-24 h-11 rounded-xl border border-border bg-background px-4 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
//             >
...
//           type="submit"
//           disabled={isPending}
//           className="h-11 w-full rounded-full bg-primary text-primary-foreground hover:opacity-90 active:scale-[0.98] transition-all mt-1 flex items-center justify-center"
//         >
...
//             <Link href="/customer/login" className="text-primary hover:underline">Log in</Link>
//           </p>
//         </div>
//       )}
//     </>
...
//   // ── BARE MODE: just the form content, no shell. Parent owns the layout. ──
//   if (bare) {
...
//   return (
//     <>
//       {/* ── MOBILE shell: only used when NOT bare (standalone usage) ── */}
//       <div className={cn("flex flex-col w-full md:hidden h-dvh overflow-hidden bg-background", className)}>
//         {/* Compact header */}
//         <div className="shrink-0 px-5 pt-5 pb-4 border-b border-border flex items-center">
//           <Logo variant="icon" href="/" />
//         </div>
...
//       <div className={cn("hidden md:block w-full max-w-sm", className)}>
//         {formContent}
//       </div>
//     </>
//   );
