...
export function DownloadButton({ storeId, startDateIso, endDateIso }: DownloadButtonProps) {
  ...
  const handleDownload = async () => {
    try {
      ...
      const base64Pdf = await downloadReceiptPdfAction(storeId, startDateIso, endDateIso);
