    ...
    <div className={cn("min-h-screen", !isCashier && "bg-background")}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar px-4 pt-5 pb-4 space-y-4">
          ...
          {/* Cart items — capped height so wallets stay reachable */}
          <section>
            ...
            {/* Scrollable items list — shows ~3 items then scrolls */}
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 py-8">
          ...
          <div className="flex gap-6 items-start">
            ...
            <div className="flex-1 min-w-0 space-y-5">
              ...
              {/* Items card — header is always visible, list scrolls internally */}
              <Card className="border-border/60 shadow-none overflow-hidden">
                ...
                {/* Scrollable items — ~5 rows visible before overflow */}
