...
//   if (step === "signUpForm") {
//     return (
//       <main className="min-h-screen w-full flex items-center justify-center md:p-8 relative overflow-hidden">
//         <div className="absolute inset-0 hidden md:block bg-muted/30 z-0" />
//         <div className="relative z-10 w-full md:max-w-5xl md:flex shadow-2xl rounded-2xl">
//           <div className="hidden md:block w-[45%] shrink-0 p-2.5">
//             <div className="h-full min-h-[600px]">
//               <SignupCarousel />
//             </div>
//           </div>
//           <div className="flex-1 md:flex md:items-center md:justify-center md:px-14 md:py-12">
//             <SignupForm userRole="customer" className="w-full md:max-w-[380px]" />
//           </div>
//         </div>
//       </main>
//     );
...
//       {/* ── MOBILE: no page scroll, fits iPhone SE (375×667) ── */}
//       <div className="flex flex-col md:hidden h-dvh overflow-hidden bg-background">

//         {/* Compact branded header — replaces the tall image */}
//         <div className="shrink-0 px-5 pt-5 pb-4 flex items-center justify-between border-b border-border bg-background">
//           <Logo variant="icon" href="/" />
//           <span className="text-xs text-muted-foreground font-medium bg-muted rounded-full px-3 py-1">
...
//         {/* Step content — only this scrolls if content overflows */}
//         <div className="flex-1 overflow-y-auto px-5 py-2 min-h-0">
//           {stepContent}
//         </div>

//         {/* Bottom nav — always visible */}
//         <div className="shrink-0 px-5 py-3 border-t border-border flex items-center justify-between bg-background">
...
//       <div className="hidden md:flex items-center justify-center w-full h-dvh bg-muted/30 p-8 overflow-hidden">
...
//               <div className="w-full max-w-md min-h-[220px]">
//                 {stepContent}
//               </div>
//             </div>
