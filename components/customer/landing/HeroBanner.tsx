  ...
  return (
    <section className="relative bg-[#f7faf7] overflow-hidden min-h-[520px] lg:min-h-[580px] flex items-center">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 1.5px 1.5px, #c8e6c9 1.5px, transparent 0)",
      ...
      <div className="lg:hidden absolute inset-0 pointer-events-none">
        ...
        >
          <Image
            src={MOBILE_BG_IMAGES.right.src}
            alt=""
            fill
            className="object-contain"
            sizes="(max-width: 1024px) 100vw, 340px"
      ...
      <div className="absolute left-0 top-0 w-[300px] xl:w-[340px] h-full pointer-events-none hidden lg:block">
        ...
        >
          <div
            className={`w-8 h-8 rounded-xl ${LEFT_CARD.iconBg} flex items-center justify-center shrink-0`}
          >
      ...
      <div className="absolute right-0 top-0 w-[300px] xl:w-[340px] h-full pointer-events-none hidden lg:block">
        ...
        >
          <div className="flex items-center justify-between mb-1">
            ...
            <span
              className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full ${RIGHT_CARD_TOP.badgeColor}`}
            >
              {RIGHT_CARD_TOP.badge}
            </span>
          </div>
          <p className="text-[11px] text-muted-foreground leading-snug">
            {RIGHT_CARD_TOP.label}
          </p>
        </div>
        <div
        ...
        >
          <div
            className={`w-8 h-8 rounded-xl ${RIGHT_CARD_BOTTOM.iconBg} flex items-center justify-center shrink-0`}
          >
            <RightCardBottomIcon
              className={`h-4 w-4 ${RIGHT_CARD_BOTTOM.iconColor}`}
            />
          </div>
          <div>
            <p className="text-xs font-bold text-foreground">
              {RIGHT_CARD_BOTTOM.title}
            </p>
            <p className="text-[10px] text-muted-foreground">
              {RIGHT_CARD_BOTTOM.subtitle}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative w-full max-w-2xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center flex flex-col items-center gap-5">
        ...
        <p className="text-muted-foreground text-base sm:text-lg leading-relaxed max-w-sm">
          Farm-fresh produce and pantry essentials exclusively for Canadian
          families.
        </p>
