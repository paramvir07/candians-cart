import StoreInvoices from "@canadian-cart/ui/store/invoice/storeInvoices";
import { Button } from "@canadian-cart/ui/ui/button";
import Link from "next/link";
import { ArrowLeft, FileWarning } from "lucide-react";
import { getStoreDetailAction } from "@canadian-cart/actions/admin/analytics/store/getStoreDetail.action";
import StoreProfileHeader from "@canadian-cart/ui/admin/analytics/store/StoreProfileHeader";
import StoreRecentOrders from "@canadian-cart/ui/admin/analytics/store/StoreRecentOrders";
import StorePayoutReceipts from "@canadian-cart/ui/admin/analytics/store/StorePayoutReciepts";
import StoreStatCards from "@canadian-cart/ui/admin/analytics/store/StoreStatsCards";
