import { allStoreDataAction } from "@canadian-cart/actions/admin/analytics/store/allStoresData.action";
import { getRecentCustomers } from "@canadian-cart/actions/admin/analytics/getRecentCustomers.action";
import RecentPayoutReceipts from "@canadian-cart/ui/admin/analytics/store/RecentPayoutReciepts";
import RecentOrders from "@canadian-cart/ui/admin/analytics/store/RecentOrders";
import StatCards from "@canadian-cart/ui/admin/analytics/store/StatsCards";
import { getRecentCashActivities } from "@canadian-cart/actions/common/getCashActivities.action";
import RecentCustomers from "@canadian-cart/ui/shared/RecentCustomers";
