import { getAllInvoicesWithPriceChange } from "@canadian-cart/actions/admin/invoice/getPriceChange";
import AllPriceChangesTable from "@canadian-cart/ui/admin/store/products/AllPriceChangeTable";
