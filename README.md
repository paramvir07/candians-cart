...
Candian's Cart is a grocery shopping web application designed to help users save money on essential grocery items through eligible subsidies, promotional savings, and a Gift Wallet system.
...
Candian's Cart operates in British Columbia, Canada.
...
The Privacy Policy explains how personal information is collected, used, stored, disclosed, and protected. Candian's Cart does not sell personal information and only shares limited data where needed to operate the service, process payments, support checkout, or comply with legal obligations.
...
Candian's Cart may rely on third-party platforms and service providers, including:
...
Candian's Cart is under active development. Current and planned improvements include:
...
For questions about Candian's Cart, contact:
