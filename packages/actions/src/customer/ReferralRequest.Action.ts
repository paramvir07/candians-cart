"use server"
import { ReferralAcceptedEmail } from "@canadian-cart/ui/EmailTemplates/ReferralAcceptEmail";
...
import ReferralRequest from "@canadian-cart/db/models/customer/ReferralRequest.model";
import { sendEmail } from "@canadian-cart/lib/auth/email";
import { getReferralRequestMessage, getReferralShareMessageTwilio, getReferralUrl } from "@canadian-cart/lib/shareMessage";
import { sendSMS } from "@canadian-cart/lib/twilio/twilio";
import mongoose from "mongoose";
import { revalidatePath } from "next/cache";
import ReferralRequestEmail from "@canadian-cart/ui/EmailTemplates/ReferralRequestEmail";
