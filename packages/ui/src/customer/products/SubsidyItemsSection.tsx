import { ISubsidyItems } from "@canadian-cart/db/models/customer/cart.model";
    ...
    <>
          ...
          {subItems.map((item, i) => {
            ...
            return (
              ...
              >
                {/* Green left accent */}
                <div
                  className="flex gap-3 p-3 border-l-[3px]"
      ...
      >
        ...
        <div
          ...
          style={{
            borderColor: "var(--border)",
            background: "oklch(0.6271 0.1699 149.2138 / 0.03)",
          }}
        >
