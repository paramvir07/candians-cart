  ...
  return (
    <Tailwind>
      <Html>
        <Head />
        <Preview>
          We received your {meta.label} — we'll be in touch within 24 hours.
        </Preview>
          ...
          <Container style={{ maxWidth: "560px", margin: "0 auto" }}>
            ...
            >
              ...
              <div style={{ padding: "44px 44px 32px", textAlign: "center" }}>
                ...
                >
                  ...
                  has been received. We&apos;ll reply to{" "}
                      ...
                      [
                        {
                          n: "1",
                          t: "Review",
                          d: "Our team will review your submission carefully.",
                        },
                        {
                          n: "2",
                          t: "Response",
                          d: "We'll reach out within 24 hours via email.",
                        },
                        {
                          n: "3",
                          t: "Resolution",
                          d: "We'll work with you until fully resolved.",
                        },
                      ] as const
                    ).map((step, i) => (
                      <tr key={step.n}>
            ...
            <div style={{ textAlign: "center", paddingTop: "24px" }}>
              ...
              <Text style={{ fontSize: "11px", color: "#9ca3af", margin: 0 }}>
                © {new Date().getFullYear()} Candian's Cart · Invite-only family
                grocery platform
              </Text>
            </div>
          </Container>
