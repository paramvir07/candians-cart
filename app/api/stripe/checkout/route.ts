  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: {
              name: "Wallet Top-up",
              description: "Canadian Cart Wallet Recharge",
            },
      ...
      custom_text: {
        submit: {
          message:
            "⚠️ NOTE: A calculated processing fee is added to cover Stripe's transaction costs. To avoid this fee, please recharge directly at your assigned Canadian's Cart store.",
        },
      },
