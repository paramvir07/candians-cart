...
export default async function StorePriceChangesPage({
  ...
  const { data: invoices, success, message } = await getInvoiceWithPriceChange(resolvedParams.storeId);

  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Invoice Price Reviews</h1>
