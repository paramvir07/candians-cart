...
export const config = {
  matcher: [
    "/((?!$|api/auth|store/login|admin/login|customer/login|cashier/login|immigration/login|customer/signup|partner-access|about|contact|terms-and-conditions|careers|privacy-policy|forgot-password|verify-phone|promotions|_next|favicon.ico|icon.png|apple-icon.png|api/stripe/webhook|sitemap\\.xml|robots\\.txt|google0e73eb402c7f3d0e\\.html).*)",
  ],
};
